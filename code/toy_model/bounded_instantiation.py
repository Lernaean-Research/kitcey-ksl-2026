...
SUMMARY_PATH = REPO_ROOT / "outputs" / "json" / "bounded_instantiation_summary.json"
SWEEP_PATH = REPO_ROOT / "outputs" / "csv" / "bounded_instantiation_sweep.csv"
...
def run() -> None:
    # Manuscript linkage: Section 3.9 bounded-domain mechanism check.
